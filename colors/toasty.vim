" `Toasty` colorscheme for vim.
" Based off of https://github.com/chriskempson/base16-vim/blob/master/colors/base16-classic-dark.vim
...
call <sid>hi("MatchParen",    s:gui07, s:gui00, s:cterm07, s:cterm00, "underline", "")
