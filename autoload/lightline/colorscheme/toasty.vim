" `Toasty` theme for lightline.
" Based off of https://github.com/mike-hearn/base16-vim-lightline/blob/master/autoload/lightline/colorscheme/base16_classic_dark.vim
